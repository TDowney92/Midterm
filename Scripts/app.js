...
// file = app.js, authors name= tyler downey website name= the trable report, file description= all of the java code is stored here.
    console.log("App Started...");

    var replaceIntroParagraph = function () {
        console.log("nside replaceIntroParagraph anonymous function");
        var IntroParagraph;
    ...
    var replaceFolegandros = function () {
        console.log("inside replaceFolegandros anonymous function");
        var Folegandros;
    ...
    var replaceAlonissos = function () {
        console.log("inside replaceAlonissos anonymous function");
        var Alonissos;
    ...
    var replaceSpetses = function () {
        console.log(" inside replaceSpetses anonymous function");
        var Spetses;
    ...
    var replaceAmorgos = function () {
        console.log(" inside replaceAmorgos anonymous function");
        var Amorgos;
    ...
    var replaceSyros = function () {
        console.log(" inside replaceSyros anonymous function");
        var Syros;
    ...
    var replaceMilos = function () {
        console.log(" inside replaceMilos anonymous function");
        var Milos;
    ...
    var replaceHydra = function () {
        console.log(" inside replaceHydra anonymous function");
        var Hydra;
    ...
    var replaceIthaca = function () {
        console.log(" inside replaceItaca anonymous function");
        var Ithaca;
    ...
    var replaceGavdos = function () {
        console.log(" inside replaceGavdos anonymous function");
        var Gavdos;
